...
const {
  gellAllBrandsController,
  addBrandController,
} = require("../controller/brands.controllers");
const { addBrandValidation } = require("../middleware/brands.middleware");
 ...
 */
brandRoute.get("/all", gellAllBrandsController);
 ...
 *         contact: 1234567890
 */
brandRoute.post("/add", roleValidator, addBrandValidation, addBrandController);
